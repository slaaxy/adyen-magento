 ...
 */
class Adyen_Fee_Block_Adminhtml_Sales_Order_Totals extends Mage_Adminhtml_Block_Sales_Order_Totals
{
     ...
     */
    protected function addPaymentFeeWithoutTax($addTaxIndationLabel = false)
    {
        if ($addTaxIndationLabel) {
     ...
     * @param bool|false $addTaxIndicationLabel
     */
    protected function addPaymentFeeWithTax($addTaxIndationLabel = false)
    {
        if ($addTaxIndationLabel) {
